...
const darkModeOn = document.querySelector("#moon")
const darkModeOff = document.querySelector("#moonDark")
...
darkModeOn.addEventListener("click", toggleDark)
darkModeOff.addEventListener("click", toggleDarkOff)
